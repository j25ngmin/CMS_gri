...
public class EgovOe1OperImprovReqVO extends EgovOe1ComDefaultVO {
	...
	public String toString() {
		return "EgovOe1OperImprovReqVO [operImprvmRequstId="
				+ operImprvmRequstId + ", operImprvmRequstSj="
				+ operImprvmRequstSj + ", operImprvmRequstCn="
				+ operImprvmRequstCn + ", operJobSeCode=" + operJobSeCode
				+ ", soperJobSeCode=" + soperJobSeCode + ", operJobSeCodeNm="
				+ operJobSeCodeNm + ", comptRequstDe=" + comptRequstDe
				+ ", requstTyCode=" + requstTyCode + ", requstTyCodeNm="
				+ requstTyCodeNm + ", emrgncyProcessAt=" + emrgncyProcessAt
				+ ", emrgncyProcessAtNm=" + emrgncyProcessAtNm + ", chargerId="
				+ chargerId + ", schargerId=" + schargerId + ", chargerNm="
				+ chargerNm + ", rcepterId=" + rcepterId + ", rceptDt="
				+ rceptDt + ", processComptDe=" + processComptDe
				+ ", processCn=" + processCn + ", stsfdg=" + stsfdg
				+ ", stsfdgOpinion=" + stsfdgOpinion + ", requstSttusCode="
				+ requstSttusCode + ", srequstSttusCode=" + srequstSttusCode
				+ ", requstSttusCodeNm=" + requstSttusCodeNm + ", returnResn="
				+ returnResn + ", requstAtchFileId=" + requstAtchFileId
				+ ", processAtchFileId=" + processAtchFileId + ", atchFileId="
				+ atchFileId + ", frstRegisterPnttm=" + frstRegisterPnttm
				+ ", frstRegisterId=" + frstRegisterId + ", frstRegisterNm="
				+ frstRegisterNm + ", lastUpdusrPnttm=" + lastUpdusrPnttm
				+ ", lastUpdusrId=" + lastUpdusrId + ", tempValue=" + tempValue
				+ ", division=" + division + ", rceptCount=" + rceptCount
				+ ", processCount=" + processCount + ", endCount=" + endCount
				+ ", endCountIn=" + endCountIn + ", endCountOver="
				+ endCountOver + ", statusCondition=" + statusCondition
				+ ", fromDate=" + fromDate + ", toDate=" + toDate
				+ ", totRequstCount=" + totRequstCount + ", preRceptCount="
				+ preRceptCount + ", changeTransCount=" + changeTransCount
