...
<div id="index_wrap">
	...
	<div id="index_content">
		<div id="title_div"><img src="${pageContext.request.contextPath}/images/egovframework/oe1/cms/com/index/img_logintitle.jpg" 
		...
		<div id="todo_div">
			<span class="more"><a href="<c:url value='/cms/cmm/EgovOe1SchdulManageList.do'/>" target="_self"><img src="${pageContext.request.contextPath}/images/egovframework/oe1/cms/com/index/btn_more.gif" alt="더보기" /></a></span>
				<table summary="전체일정">
		...
		<div id="notice_div">	
			...
			<span class="more"><a href="<c:url value='/cms/cmm/selectBoardList.do'/>?bbsId=<c:out value='${boardVO2.bbsId}'/>" target="_self"><img src="${pageContext.request.contextPath}/images/egovframework/oe1/cms/com/index/btn_more.gif" alt="더보기" /></a></span>
			<table summary="공지사항">
		...
		<div id="board_div">
			<span class="more"><a href="<c:url value='/cms/cmm/selectBoardList.do'/>?bbsId=<c:out value='${boardVO1.bbsId}'/>" target="_self"><img src="${pageContext.request.contextPath}/images/egovframework/oe1/cms/com/index/btn_more.gif" alt="더보기" /></a></span>
				<table summary="게시판">
				<caption>게시판</caption>
					<tbody>					
		...
		<div id="download_div">
			<span class="more"><a href="<c:url value='/cms/cmm/selectBoardList.do'/>?bbsId=<c:out value='${boardVO3.bbsId}'/>" target="_self"><img src="${pageContext.request.contextPath}/images/egovframework/oe1/cms/com/index/btn_more.gif" alt="더보기" /></a></span>
			<table summary="다운로드">
	...
	<div id="login_div">
		...
		<c:choose>
			<c:when test="${empty s_mberId}">
				<form onsubmit="actionLogin()" action ="<c:url value='/cms/com/actionLogin.do'/>" method="post" name="login_form">
					...
					<div id="login_btn_area"><a href="javascript:actionLogin(); return false;" target="_self"><input type="image" src="${pageContext.request.contextPath}/images/egovframework/oe1/cms/com/index/btn_login.gif" alt="로그인하기" /></a>
					</div>		
				...
				<c:otherwise>
					<form onsubmit="actionLogout()" action ="<c:url value='/cms/com/actionLogout.do'/>" method="post" name="login_form2">
						...
						<a href="javascript:updateUser()"><img src="${pageContext.request.contextPath}/images/egovframework/oe1/cms/com/index/pinfo_modify.gif" alt="비밀번호변경" /></a>
						</c:if>
						<a href="javascript:actionLogout()"><img src="${pageContext.request.contextPath}/images/egovframework/oe1/cms/com/index/logout.jpg" alt="로그아웃" /></a>
						</div>
					</form>	
				</c:otherwise>
		</c:choose>
		...
		<div id="banner_area">
		<p><img src="${pageContext.request.contextPath}/images/egovframework/oe1/cms/com/index/banner01.gif" alt="대한민국의 전자표준프레임의 미래 eGovframe" /></p>
		<p><img src="${pageContext.request.contextPath}/images/egovframework/oe1/cms/com/index/banner01.gif" alt="대한민국의 전자표준프레임의 미래 eGovframe" /></p>
		<p><img src="${pageContext.request.contextPath}/images/egovframework/oe1/cms/com/index/banner01.gif" alt="대한민국의 전자표준프레임의 미래 eGovframe" /></p>
		</div>
	</div>	
